...
class AyaTranslator {
  constructor(apiKey, options = {}) {
    this.apiKey = apiKey;
    this.baseURL = options.baseURL || process.env.AYA_SERVER_URL || 'http://localhost:3001';
...
/**
 * Factory function (DeepL-compatible)
 */
function Translator(apiKey, options = {}) {
  return new AyaTranslator(apiKey, options);
}

module.exports = { Translator, AyaTranslator };